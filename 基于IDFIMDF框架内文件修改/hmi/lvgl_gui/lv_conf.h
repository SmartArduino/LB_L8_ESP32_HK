 ...
 *----------------*/
 ...
 #define USR_DEF_LV_MEM_SIZE (24U * 1024U)
...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    USR_DEF_LV_MEM_SIZE  /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
#define LV_MEM_ATTR                         /*Complier prefix for big array declaration*/
#define LV_MEM_AUTO_DEFRAG  1               /*Automatically defrag on free*/
#else       /*LV_MEM_CUSTOM*/
#define LV_MEM_CUSTOM_INCLUDE <os.h>   /*Header for the dynamic memory function*/
#define LV_MEM_CUSTOM_ALLOC   os_zalloc       /*Wrapper to malloc*/
#define LV_MEM_CUSTOM_FREE    os_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/

#define LV_STYLE_MEM_FREE(a)	if(NULL != a){os_free(a);a = NULL;}
...
//#define LV_HOR_RES			L8_DEV_SCREEN_SIZE_HOR
//#define LV_VER_RES			L8_DEV_SCREEN_SIZE_VER
...
extern int L8_DEV_SCREEN_SIZE_HOR;
extern int L8_DEV_SCREEN_SIZE_VER;

extern bool devStatusDispMethod_landscapeIf_get(void);

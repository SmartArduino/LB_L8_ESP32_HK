...
lv_obj_t * lv_tabview_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    if(copy == NULL) {
        ...
        lv_obj_set_size(new_tabview, L8_DEV_SCREEN_SIZE_HOR, L8_DEV_SCREEN_SIZE_VER);
        ...
        lv_obj_set_height(ext->content, L8_DEV_SCREEN_SIZE_VER - lv_obj_get_height(ext->btns));
